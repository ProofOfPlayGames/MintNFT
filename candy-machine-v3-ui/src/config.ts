...
export const collectionImageURL =
  process.env.NEXT_PUBLIC_COLLECTION_IMAGE_URL || "https://arweave.net/_VwEn_aDTgY_DrFflX3xsGbk90XYSLtDsmg2NE0iAoM?ext=png";

export const collectionTitle =
  process.env.NEXT_PUBLIC_COLLECTION_TITLE || "POP Games - Controllers";

export const collectionDescription =
  process.env.NEXT_PUBLIC_COLLECTION_DESCRIPTION || "Proof of Play Games - NFT Controllers\nMint a Proof of Play Controller NFT to earn tokens while playing POP Games!";
